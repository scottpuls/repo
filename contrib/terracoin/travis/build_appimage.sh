...
APPDIR="$BUILDDIR/electrum-trc.AppDir"
...
APPIMAGE="$DISTDIR/Terracoin-Electrum-$VERSION-x86_64.AppImage"
...
info "installing electrum-trc and its dependencies."
...
cp "$PROJECT_ROOT/electrum-trc.desktop" "$APPDIR/electrum-trc.desktop"
cp "$PROJECT_ROOT/electrum_trc/gui/icons/electrum-trc.png" "$APPDIR/electrum-trc.png"


# add launcher
cp "$CONTRIB/terracoin/travis/apprun.sh" "$APPDIR/AppRun"
