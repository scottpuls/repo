...
try:
    imp.load_module('electrum_trc', *imp.find_module('../electrum_trc'))
    from electrum_trc import constants, keystore, storage, SimpleConfig
    from electrum_trc.version import ELECTRUM_VERSION
    from electrum_trc.gui.qt import update_checker
    from electrum_trc.plugin import Plugins
    from electrum_trc.storage import WalletStorage
    from electrum_trc.util import InvalidPassword
...
CONFIG_NAME = '.update-last-version-trc-electrum'
