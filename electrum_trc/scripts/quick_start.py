...
from electrum_trc.daemon import Daemon
from electrum_trc.storage import WalletStorage
from electrum_trc.wallet import Wallet, create_new_wallet
from electrum_trc.commands import Commands


config = SimpleConfig({"testnet": True})  # to use ~/.electrum-trc/testnet as datadir
