...
<SettingsDialog@Popup>
    id: settings
    title: _('Terracoin Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Terracoin amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_trc/gui/kivy/uix/ui_screens/proxy.kv')
