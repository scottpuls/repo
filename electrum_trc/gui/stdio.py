...
from electrum_trc import WalletStorage, Wallet
...
from electrum_trc.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Terracoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-trc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-trc setconfig' to change your settings")
        return True
