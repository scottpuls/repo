...
from electrum_trc import version
from electrum_trc import constants
from electrum_trc import ecc
from electrum_trc.i18n import _
from electrum_trc.util import make_aiohttp_session, versiontuple
from electrum_trc.logging import Logger


class UpdateCheck(QWidget, Logger):
    url = "https://raw.githubusercontent.com/terracoin/electrum-trc/master/.latest-version"
    download_url = "https://github.com/terracoin/electrum-trc/releases"


    VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "1LMF4gAhwUX8TN6e5Ff6m89oZG2HRcg7jL",
    )

    def __init__(self, main_window, latest_version=None):
        self.main_window = main_window
        QWidget.__init__(self)
        self.setWindowTitle('Terracoin Electrum - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Terracoin Electrum."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Terracoin Electrum checks for available updates."))
