...
from electrum_trc.masternode_budget import BudgetProposal, BudgetVote
from electrum_trc.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_trc.util import block_explorer_URL, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://services.terracoin.io/p/%s' % identifier
...
class ProposalsTab(QWidget, util.MessageBoxMixin):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 10 TRC to create. ',
        ...
        form.addRow(_('Payment Address:'), self.address_edit)
        form.addRow(_('Monthly TRC Payment:'), self.amount_edit)
