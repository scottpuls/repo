...
from electrum_trc.bitcoin import COIN
from electrum_trc.i18n import _
from electrum_trc.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 5000 TRC output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 5000 TRC output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 5000 TRC was sent to'))
...
class MasternodeOutputsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        desc = ' '.join(['Use this tab to scan for and choose a collateral payment for your masternode.',
            'A valid collateral payment is exactly 5000 TRC.'])
        desc = QLabel(_(desc))
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 5000 TRC outputs were found.'))
    ...
    def set_mapper_index(self, row):
        ...
        if mn.vin.get('value', 0) == COIN * 5000:
            can_scan = False
...
class SignAnnounceWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        form = QFormLayout()
        form.addRow(_('Alias:'), self.alias_edit)
        form.addRow(_('Collateral TRC Output:'), self.collateral_edit)
