...
from electrum_trc.wallet import Wallet, Abstract_Wallet
from electrum_trc.storage import WalletStorage
from electrum_trc.util import UserCancelled, InvalidPassword, WalletFileException
from electrum_trc.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
WIF_HELP_TEXT = (_('WIF keys are typed in Terracoin Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:KzMFjMC2MPad...       \t-> 17azqT8T...\n')
# note: full key is KzMFjMC2MPadjvX5Cd7b8AKKjjpBSoRKUTpoAtN6B3J9ezWYyXS6
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              + _("You have multiple consecutive whitespaces or leading/trailing "
                                  "whitespaces in your passphrase.") + " " \
                              + _("This is discouraged.") + " " \
                              + _("Due to a bug, old versions of Terracoin Electrum will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.setWindowTitle('Terracoin Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-trc.png')
        self.show()
        self.raise_()
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Terracoin Electrum wallet'))
    ...
    def run_upgrades(self, storage):
        ...
        if storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since Terracoin Electrum 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("Terracoin Electrum communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Terracoin Electrum "
