"""Terracoin look and feel."""

import os
from electrum_trc.util import pkg_dir


terracoin_stylesheet = """
...
QPushButton { /* Global Button Style */
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #5adc4c, stop: .1 #44ce2c, stop: .95 #44ce2c, stop: 1 #36641d);
    border:0;
    border-radius:3px;
    color:#ffffff;
    /* font-size:12px; */
...
QPushButton:hover {
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #5adc4c, stop: .1 #5adc4c, stop: .95 #5adc4c, stop: 1 #36641d);
}
...
{
    color: #d7fed2;
    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #a6faa3, stop: 1 #81f872);
}
...
QComboBox::down-arrow {
    border-image: url({pkg_dir}/gui/icons/terracoin_downArrow.png) 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-button {
    ...
    background:#fcfcfc;
    border-left:0px;
    border-right:1px solid #0c8843;
    border-top:1px solid #0c8843;
    border-bottom:0px;
    padding-right:1px;
    padding-left:5px;
    padding-top:2px;
...
QAbstractSpinBox::down-button {
    ...
    border-left:0px;
    border-right:1px solid #0c8843;
    border-bottom:1px solid #0c8843;
    padding-right:1px;
    padding-left:5px;
    padding-bottom:2px;
}
...
QAbstractSpinBox::up-arrow {
    image: url({pkg_dir}/gui/icons/terracoin_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url({pkg_dir}/gui/icons/terracoin_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url({pkg_dir}/gui/icons/terracoin_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url({pkg_dir}/gui/icons/terracoin_downArrow_small_disabled.png);
}
...
QHeaderView::section { /* Table Header Sections */
    ...
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0.25, stop: 0 #65cf63, stop: 1 #70d567);
    color:#fff;
    font-weight:bold;
    font-size:11px;
    outline:0;
    border:0;
    border-right:1px solid #62d855;
    padding-left:2px;
    padding-right:10px;
    padding-top:1px;
    padding-bottom:1px;
...
QScrollBar:up-arrow {
    background-image: url({pkg_dir}/gui/icons/terracoin_upArrow_small.png);
}

QScrollBar:down-arrow {
    background-image: url({pkg_dir}/gui/icons/terracoin_downArrow_small.png);
}

QScrollBar:left-arrow {
    background-image: url({pkg_dir}/gui/icons/terracoin_leftArrow_small.png);
}

QScrollBar:right-arrow {
    background-image: url({pkg_dir}/gui/icons/terracoin_rightArrow_small.png);
}
...
terracoin_stylesheet = terracoin_stylesheet.replace('{pkg_dir}', '%s' % pkg_dir_for_css)
