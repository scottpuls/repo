...
from .terracoin_tx import (TxOutPoint, ProTxService, TerracoinProRegTx, TerracoinProUpServTx,
                      TerracoinProUpRegTx, TerracoinProUpRevTx, TerracoinCbTx, SPEC_PRO_REG_TX,
...
class ProTxManager(Logger):
    ...
    def prepare_pro_reg_tx(self, alias):
        ...
        tx = TerracoinProRegTx(1, mn.type, mn.mode, mn.collateral, mn.service.ip,
    ...
    def prepare_pro_up_srv_tx(self, mn):
        ...
        tx = TerracoinProUpServTx(1, bfh(mn.protx_hash)[::-1],
    ...
    def prepare_pro_up_reg_tx(self, mn):
        ...
        tx = TerracoinProUpRegTx(1, bfh(mn.protx_hash)[::-1], mn.mode,
    ...
    def prepare_pro_up_rev_tx(self, alias, reason):
        ...
        tx = TerracoinProUpRevTx(1, bfh(mn.protx_hash)[::-1], reason,
                            b'\x00'*32, b'\x00'*96)
        return tx
    ...
    async def on_protx_diff(self, key, value):
        ...
        if not isinstance(cbtx_extra, TerracoinCbTx):
