...
BUDGET_PAYMENTS_CYCLE_BLOCKS = 50 if constants.net.TESTNET else 21600
SUBSIDY_HALVING_INTERVAL = 1050000
...
class BudgetProposal(object):
    ...
    def check_valid(self):
        ...
        if self.payment_amount < bitcoin.COIN:
            raise ValueError(_('Payments must be at least 1 TRC.'))

        # Calculate max budget.
        subsidy = 20 * bitcoin.COIN
        halvings = self.start_block / SUBSIDY_HALVING_INTERVAL
        subsidy = subsidy >> int(halvings)
