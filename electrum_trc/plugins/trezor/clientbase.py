...
from electrum_trc.util import UserCancelled, UserFacingException
from electrum_trc.keystore import bip39_normalize_passphrase
...
from electrum_trc.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
...
class TrezorClientBase(Logger):
    ...
    def has_usable_connection_with_device(self):
        ...
        try:
            res = self.client.ping("electrum-trc pinging device")
            assert res == "electrum-trc pinging device"
    ...
    def get_passphrase(self):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the terracoins in the wallet.").format(self.device)
        else:
