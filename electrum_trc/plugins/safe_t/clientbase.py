...
from electrum_trc.util import UserCancelled
from electrum_trc.keystore import bip39_normalize_passphrase
from electrum_trc.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32
...
class SafeTClientBase(GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("electrum-trc pinging device")
