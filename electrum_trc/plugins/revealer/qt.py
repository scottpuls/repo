...
from electrum_trc.plugin import hook
from electrum_trc.i18n import _
from electrum_trc.util import make_dir, InvalidPassword, UserCancelled
from electrum_trc.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                       WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_trc.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_trc.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_trc.gui.qt.password_dialog import PasswordDialog
