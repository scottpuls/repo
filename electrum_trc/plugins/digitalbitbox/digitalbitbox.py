...
from electrum_trc.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_trc.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from electrum_trc.bip32 import BIP32Node
from electrum_trc import ecc
from electrum_trc.ecc import msg_magic
...
from electrum_trc.util import to_string, UserCancelled, UserFacingException
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Terracoin-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
